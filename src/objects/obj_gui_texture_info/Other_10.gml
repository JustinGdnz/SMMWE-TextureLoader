...
desc_box = text_create_box(x+153, y+40, 82, 80, depth-5, "[c_black]"+description)
credits_box = text_create_hyperlink_box(x+244, y+40, 63, 80, depth-5, "[c_black]"+_text, "dummy", c_red, 0.8, open_supporturl)